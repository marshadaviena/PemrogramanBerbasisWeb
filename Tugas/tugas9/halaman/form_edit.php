...
<body>
   <div class="container mt-4">
       ...
       <form method="post" action="../view/proses_edit.php">
           ...
           <div class="mb-3">
               ...
               <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" value="<?= htmlspecialchars($row['Tahun_Terbit']) ?>" required>
           </div>

           <div class="mb-3">
               <label for="harga" class="form-label">Harga</label>
               <input type="number" class="form-control" id="harga" name="harga" value="<?= htmlspecialchars($row['Harga']) ?>" step="0.01" required>
           </div>
